...
SECRET_KEY = 'django-insecure-+8+hm#+=zch%e$%e0spqza)@-c&!*4l)$z%#8^6yo7z+a9q@#i'
...
DATABASES = {
        'default': {
            ...
            'NAME': 'aprender_sistema_db',              # OK
            'USER': 'adm_aprender',                     # OK
            'PASSWORD': 'aprender123456',               # OK
            'HOST': 'db',                               # OK: 'db' é o nome do serviço do Docker
            'PORT': '5432',                             # OK
        }
    }
