...
class DashboardPerformanceTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.projeto = Projeto.objects.create(
            ...
            descricao='Projeto para testes de performance'
        )
        ...
        self.tipo_evento = TipoEvento.objects.create(
            nome='Workshop Performance',
            online=False
        )
        
        self.formador = Formador.objects.create(
            nome='João Performance',
            email='joao.perf@test.com',
            ativo=True
        )
        ...
        for i in range(20):  # 20 solicitações para testar
            evento = Solicitacao.objects.create(
                ...
                status=SolicitacaoStatus.APROVADO if i % 3 == 0 else SolicitacaoStatus.PENDENTE
            )
    ...
    def test_cache_behavior_cold_vs_warm(self):
        ...
        self.assertGreater(speed_improvement, 0.1, 
    ...
    def test_api_response_time_under_threshold(self):
        ...
        self.assertLess(response_time, 1.0, 
                       f"API muito lenta: {response_time:.3f}s")
        ...
        self.assertLess(cached_response_time, 0.1, 
                       f"Cache muito lento: {cached_response_time:.3f}s")
...
class DashboardMigrationTestCase(TestCase):
    ...
    def test_performance_indexes_exist(self):
        ...
        self.assertGreaterEqual(found_indexes, 3, 
