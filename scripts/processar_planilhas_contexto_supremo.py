...
class ProcessadorPlanilhasContextoSupremo:
    ...
    def __init__(self):
        self.planilhas_config = {
            'agenda_2025': {
                ...
                'mapeamento_colunas': {
                    'ACerta': ['Criado na Agenda', 'município', 'encontro', 'tipo', 'data', 
                    ...
                    'Outros': ['Criado na Agenda', 'município', 'encontro', 'tipo', 'data',
                              'hora início', 'hora fim', 'projeto', 'segmento', 'Coord Acompanha',
                              'Coordenador', 'Formador 1', 'Formador 2', 'Formador 3',
                              'Formador 4', 'Formador 5', 'Convidados'],
                    'Brincando': ['Criado na Agenda', 'município', 'encontro', 'tipo', 'data',
                                 'hora início', 'hora fim', 'projeto', 'segmento', 'Coord Acompanha',
                                 'Coordenador', 'Formador 1', 'Formador 2', 'Formador 3',
                                 'Formador 4', 'Formador 5', 'Convidados'],
                    'Vidas': ['Criado na Agenda', 'município', 'encontro', 'tipo', 'data',
                             'hora início', 'hora fim', 'projeto', 'segmento', 'Coord Acompanha',
                             'Coordenador', 'Formador 1', 'Formador 2', 'Formador 3',
                             'Formador 4', 'Formador 5', 'Convidados'],
                    'Super': ['Criado na Agenda', 'Aprovação', 'Municípios', 'encontro', 'tipo',
            ...
            'controle_2025': {
                ...
                'abas': ['🟥 AÇÕES', '🟥 COMPRAS', 'ℹ️ FILTRO_PROD.', 'ℹ️ FORMAÇÕES', 
    ...
    def processar_agenda_2025(self, aba_especifica: Optional[str] = None):
        ...
        abas_para_processar = [aba_especifica] if aba_especifica else list(config['abas'].keys())
    ...
    def processar_controle_2025(self):
        ...
        logger.info("  - Aba DAT: Ações nas plataformas Aprender Avaliar e Aprender Formar...")
    ...
    def executar_processamento_completo(self):
        ...
        try:
            ...
            for planilha, resultado in resultados.items():
                logger.info(f"✅ {planilha.upper()}: {resultado.get('status', 'processado')}")
...
def main():
    ...
    try:
        ...
        with open('resultados_processamento_contexto_supremo.json', 'w', encoding='utf-8') as f:
            json.dump(resultados, f, indent=2, ensure_ascii=False, default=str)
        
        logger.info("💾 Resultados salvos em: resultados_processamento_contexto_supremo.json")
