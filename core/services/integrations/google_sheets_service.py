...
class GoogleSheetsService:
    ...
    def read_sheet_data(self, spreadsheet_key: str, worksheet_name: str = None) -> List[List[str]]:
        """
    ...
    def write_sheet_data(self, spreadsheet_key: str, data: List[List[str]], 
                        worksheet_name: str = None, start_cell: str = 'A1'):
        """
    ...
    def append_row(self, spreadsheet_key: str, row_data: List[str], 
    ...
    def find_cell(self, spreadsheet_key: str, search_value: str, 
                  worksheet_name: str = None):
