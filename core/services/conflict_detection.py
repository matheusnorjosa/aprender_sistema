...
from core.models import (
    Solicitacao, SolicitacaoStatus, Formador, 
    DisponibilidadeFormadores, Deslocamento
)
...
class ConflictDetector:
    ...
    def detect_conflicts(self, solicitacao: Solicitacao, formadores: List[Formador]) -> Dict[str, List[Dict]]:
        """
    ...
    def _check_formador_conflicts(self, solicitacao: Solicitacao, formador: Formador) -> List[Dict]:
    ...
    def _check_availability_blocks(self, solicitacao: Solicitacao, formador: Formador) -> List[Dict]:
        ...
        for bloqueio in bloqueios:
            ...
            if bloqueio.tipo_bloqueio.upper() in ['T', 'TOTAL', 'BLOQUEIO TOTAL']:
                conflicts.append({
                    ...
                    'details': {
                        'formador': formador.usuario.get_full_name() if formador.usuario else formador.nome,
                        'data': data_evento,
    ...
    def _check_event_overlaps(self, solicitacao: Solicitacao, formador: Formador) -> List[Dict]:
    ...
    def _check_travel_buffer(self, solicitacao: Solicitacao, formador: Formador) -> List[Dict]:
            ...
            if tempo_entre < self.buffer_deslocamento:
                conflicts.append({
                    ...
                    'details': {
                        ...
                        'tempo_disponivel_minutos': int(tempo_entre.total_seconds() // 60),
                        'tempo_necessario_minutos': int(self.buffer_deslocamento.total_seconds() // 60),
    ...
    def _check_daily_capacity(self, solicitacao: Solicitacao, formador: Formador, max_horas_dia: int = 10) -> List[Dict]:
        ...
        duracao_nova = (solicitacao.data_fim - solicitacao.data_inicio).total_seconds() / 3600
    ...
    def _datetime_ranges_overlap(self, range1: Tuple, range2: Tuple, allow_adjacent: bool = False) -> bool:
        """
    ...
    def format_conflicts_for_display(self, conflicts: Dict[str, List[Dict]]) -> List[str]:
        """
