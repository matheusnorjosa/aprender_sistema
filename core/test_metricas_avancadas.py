...
class MetricasAvancadasTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.projeto1 = Projeto.objects.create(
            nome='Projeto Métricas Alpha',
            descricao='Primeiro projeto para métricas'
        )
        
        self.projeto2 = Projeto.objects.create(
            nome='Projeto Métricas Beta',
            descricao='Segundo projeto para métricas'
        )
    ...
    def _criar_dados_teste(self):
        ...
        FormadoresSolicitacao.objects.create(solicitacao=evento4, formador=self.formador3)
        ...
        FormadoresSolicitacao.objects.create(solicitacao=evento5, formador=self.formador2)
