...
def carregar_dados():
    ...
    with open('dados_tratados_organizados_20250919_225631.json', 'r', encoding='utf-8') as f:
...
def gerar_excel_principal(dados_tratados):
    ...
    with pd.ExcelWriter(arquivo, engine='openpyxl') as writer:
        for i, (chave_aba, dados) in enumerate(dados_tratados.items()):
            ...
            print(f"  📋 Processando aba {i+1}/{len(dados_tratados)}: {chave_aba[:30]}...")
...
def gerar_excel_categorias():
    ...
    with open('dados_organizados_por_categoria_20250919_225631.json', 'r', encoding='utf-8') as f:
