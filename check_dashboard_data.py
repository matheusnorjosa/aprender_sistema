...
class DashboardDataChecker:
    ...
    def check_dashboard_service(self):
        ...
        try:
            ...
            print(
                f"  ✅ DashboardService.get_dashboard_stats(): {len(dashboard_stats)} estatísticas"
            )
            ...
            if "total_coordenadores" in dashboard_stats:
                print(
                    f"    • Total coordenadores: {dashboard_stats['total_coordenadores']}"
                )
    ...
    def check_dashboard_specific_data(self):
        ...
        try:
            ...
            coordenadores_por_municipio = (
                DashboardService.get_coordenadores_por_municipio()
            )
            print(
                f"  📊 Coordenadores por município: {len(coordenadores_por_municipio)} registros"
            )
            ...
            print(
                f"  📊 Solicitações por status: {len(solicitacoes_por_status)} registros"
            )
