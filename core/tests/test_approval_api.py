...
class BulkApprovalAPITest(TestCase):
    ...
    def setUp(self):
        ...
        self.formador = Formador.objects.create(
            nome='João Silva Aprovação',
            email='joao.aprovacao@test.com',
            ativo=True
        )
    ...
    def test_bulk_approval_already_processed(self):
        ...
        data = {
            'solicitacao_ids': [str(solicitacao.id)],
            'acao': 'aprovar'
        }
...
class SolicitacoesPendentesAPITest(TestCase):
    ...
    def setUp(self):
        ...
        # Criar dados básicos
        self.municipio1 = Municipio.objects.create(nome='Fortaleza', uf='CE', ativo=True)
        self.municipio2 = Municipio.objects.create(nome='São Paulo', uf='SP', ativo=True)
        
        self.projeto = Projeto.objects.create(
            nome='Projeto Pendentes',
            ativo=True,
        ...
        self.formador = Formador.objects.create(
            nome='Formador Pendentes',
            email='formador.pendentes@test.com',
            ativo=True
        )
...
class SolicitacaoConflictsAPITest(TestCase):
    ...
    def setUp(self):
        ...
        self.formador = Formador.objects.create(
            nome='Formador Conflicts',
            email='formador.conflicts@test.com',
            ativo=True
        )
    ...
    def test_conflicts_analysis_no_conflicts(self):
        ...
        url = reverse('core:solicitacao_conflicts_api', kwargs={'solicitacao_id': self.solicitacao.id})
    ...
    def test_conflicts_analysis_nonexistent_solicitacao(self):
        ...
        import uuid
        fake_id = uuid.uuid4()
        url = reverse('core:solicitacao_conflicts_api', kwargs={'solicitacao_id': fake_id})
