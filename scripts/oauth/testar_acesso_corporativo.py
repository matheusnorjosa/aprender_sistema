...
def testar_acesso_publico():
    ...
    url = (
        f"https://sheets.googleapis.com/v4/spreadsheets/{PLANILHA_ID}?key=YOUR_API_KEY"
    )
...
def verificar_url_arquivo_drive():
    ...
    gsheet_path = (
        r"G:\Drives compartilhados\Suporte\Acompanhamento de Agenda   2025.gsheet"
    )
    ...
    print(
        "   https://docs.google.com/spreadsheets/d/16ul8qvHb-1CRs5Z7zYcVP9Rh2munCefWWNsAiJfZYYU"
    )
...
if __name__ == "__main__":
    ...
    print(
        "1. Confirme se planilha esta compartilhada com aprender-sistema@aprendereditora.com.br"
    )
