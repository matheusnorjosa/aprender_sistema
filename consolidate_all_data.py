...
def consolidate_all_spreadsheets():
    ...
    for key, arquivo in arquivos:
        ...
        try:
            ...
            print(f'OK: {data.get("planilha_nome", arquivo)} - {total_planilha} registros')
    ...
    dados_consolidados['consolidacao_completa']['total_geral_registros'] = total_geral_registros
