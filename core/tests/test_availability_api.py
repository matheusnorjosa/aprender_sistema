...
from core.models import (
    ...
    DisponibilidadeFormadores, Solicitacao, SolicitacaoStatus
)
...
class CheckAvailabilityAPITest(TestCase):
    ...
    def setUp(self):
        ...
        self.projeto = Projeto.objects.create(
            ...
            descricao='Projeto para testar API',
            ativo=True
        )
        
        self.tipo_evento = TipoEvento.objects.create(
            nome='Capacitação Online API',
            online=True,
            ativo=True
        )
...
class FormadorDetailsAPITest(TestCase):
    ...
    def setUp(self):
        ...
        self.formador = Formador.objects.create(
            nome='Formador Detalhes',
            email='detalhes@test.com',
            ativo=True
        )
