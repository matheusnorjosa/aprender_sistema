...
class Command(BaseMigrationCommand):
    ...
    def parse_evento_row(self, row: List, headers: List, options: Dict) -> Dict[str, Any]:
        """
    ...
    def create_or_update_evento(self, evento_data: Dict[str, Any], options: Dict):
        ...
        try:
            ...
            self.stats['errors'] += 1
            self.logger.error(f"Erro criando evento {evento_data.get('titulo', 'desconhecido')}: {e}")
            raise