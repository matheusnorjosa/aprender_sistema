...
class Usuario(AbstractUser):
    ...
    def can_approve_requests(self):
        ...
        return (self.cargo == 'gerente' and 
                self.setor and 
                self.setor.vinculado_superintendencia)
...
class LogComunicacao(models.Model):
    ...
    def __str__(self):
        destinatario = self.usuario_destinatario.username if self.usuario_destinatario else self.grupo_destinatario
        status_icon = "✓" if self.status_envio == 'enviado' else "✗" if self.status_envio == 'falhado' else "⏳"
