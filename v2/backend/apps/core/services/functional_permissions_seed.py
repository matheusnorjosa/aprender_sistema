...
FUNCTIONAL_PERMISSIONS_SEED: tuple[FunctionalPermissionSeed, ...] = (
    FunctionalPermissionSeed(
        ...
        description="Permite aprovar ou reprovar solicitacoes pendentes.",
    ...
    FunctionalPermissionSeed(
        ...
        description="Permite aprovar varias solicitacoes de uma vez.",
        category="solicitacao",
    ...
    FunctionalPermissionSeed(
        ...
        description="Permite executar operacoes restritas, como exclusoes criticas.",
        category="solicitacao",
        group_names=("Superintendência",),
    ),
    FunctionalPermissionSeed(
        ...
        description="Permite criar novas solicitacoes no sistema.",
        category="solicitacao",
    ...
    FunctionalPermissionSeed(
        ...
        description="Permite importar planilhas e controlar dados do sistema.",
        category="importacao",
    ...
    FunctionalPermissionSeed(
        ...
        label="Operacao DAT",
        description="Permite gerenciar cadastros e configuracoes do DAT.",
        category="admin_dat",
        group_names=("DAT",),
    ),
    FunctionalPermissionSeed(
    ...
    FunctionalPermissionSeed(
        ...
        description="Permite acesso a funcionalidades exclusivas do DAT.",
        category="admin_dat",
        group_names=("DAT",),
    ),
    FunctionalPermissionSeed(
        ...
        description="Permite operacoes compartilhadas entre Controle e DAT.",
        category="operacao",
    ...
    FunctionalPermissionSeed(
        ...
        description="Permite operacoes exclusivas do setor Controle.",
        category="operacao",
    ...
    FunctionalPermissionSeed(
        ...
        description="Permite atuacao gerencial e supervisao operacional.",
        category="gerencia",
    ...
    FunctionalPermissionSeed(
        ...
        description="Permite editar solicitacoes proprias ou de outros usuarios.",
        category="solicitacao",
        group_names=("Superintendência", "DAT"),
    ),
)
