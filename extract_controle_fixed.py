    ...
    try:
        ...
        for worksheet in sheet.worksheets():
            ...
            try:
                ...
                print(f'  OK Linhas: {len(clean_data)}, Colunas: {len(clean_data[0]) if clean_data else 0}')
        ...
        # Resumo da extração
        total_records = sum(aba_data['total_rows'] for aba_data in worksheets_data.values())
