...
def analyze_database_schema_sqlite():
    ...
    with connection.cursor() as cursor:
        ...
        for (table_name,) in tables:
            ...
            print(f'Tabela: {table_name} - {len(columns)} colunas, {row_count} registros')
...
def analyze_models_vs_database():
    ...
    return {
        ...
        'total_models': len(django_models)
    }
...
def analyze_data_distribution():
    ...
    key_tables = ['core_usuario', 'core_solicitacao', 'core_projeto', 'core_municipio', 'core_formador']
