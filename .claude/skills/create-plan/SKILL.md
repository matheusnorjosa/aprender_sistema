---
name: create-plan
description: Create detailed implementation plans through interactive research. Use when the user asks to plan a feature/epic/refactor before implementing, or invokes /create-plan with a ticket/spec.
...
Tip: You can also invoke this command with a GitHub issue or spec directly: `/create-plan #1234` or `/create-plan v2/docs/specs/backend/imports.spec.md`
For deeper analysis, try: `/create-plan think deeply about #1234`
```
...
On approval, the plan is ready for `/implement-plan`.
