...
def test_security_features():
    ...
    print(f'OK SESSION_COOKIE_SECURE: {getattr(settings, "SESSION_COOKIE_SECURE", False)}')
    ...
    print(f'OK CSRF_COOKIE_SECURE: {getattr(settings, "CSRF_COOKIE_SECURE", False)}')
    print(f'OK SECURE_HSTS_SECONDS: {getattr(settings, "SECURE_HSTS_SECONDS", 0)}')
    print(f'OK SECURE_CONTENT_TYPE_NOSNIFF: {getattr(settings, "SECURE_CONTENT_TYPE_NOSNIFF", False)}')
    print(f'OK SECURE_BROWSER_XSS_FILTER: {getattr(settings, "SECURE_BROWSER_XSS_FILTER", False)}')
    ...
    print(f'OK CSRF_COOKIE_HTTPONLY: {getattr(settings, "CSRF_COOKIE_HTTPONLY", False)}')
    print(f'OK SESSION_COOKIE_HTTPONLY: {getattr(settings, "SESSION_COOKIE_HTTPONLY", True)}')
    ...
    checklist = [
        ...
        ('Cookies seguros habilitados', getattr(settings, 'SESSION_COOKIE_SECURE', False)),
