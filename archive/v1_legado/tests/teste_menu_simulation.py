...
def simulate_menu_visibility():
    ...
    menu_conditions = {
        ...
        "Mapa Mensal": lambda perms: any(
            p in perms for p in ["view_aprovacao", "view_relatorios", "sync_calendar"]
        ),
        ...
        "Formações": lambda perms: any(
            p in perms for p in ["view_formacao", "add_compra"]
        ),
        "Importar Compras": lambda perms: any(
            p in perms for p in ["view_formacao", "add_compra"]
        ),
...
def test_specific_gaps():
    ...
    gaps_tests = [
        ...
        (
            "G7 - Superintendência acessa Municípios",
            "superintendencia",
            "view_municipio",
        ),
    ]
