...
- **`deploy.yaml`** — *Deploy (Portainer CE)*. Pós-merge: PUT image tag via API Portainer (porta 9443) + health/version polling. Falhas `curl 28` em rajada de merges são transientes.
