...
from apps.core.models import Usuario, Projeto, Municipio, TipoEvento, Solicitacao
...
def user_super(grupos):
    ...
    user = Usuario.objects.create_user(
        username='super1', email='super@x.com', password='x', cpf='11111111111'
    )
...
def user_controle(grupos):
    ...
    user = Usuario.objects.create_user(
        username='controle1', email='controle@x.com', password='x', cpf='22222222222'
    )
...
def user_dat(grupos):
    ...
    user = Usuario.objects.create_user(
        username='dat1', email='dat@x.com', password='x', cpf='33333333333'
    )
...
def user_coordenador(grupos):
    ...
    user = Usuario.objects.create_user(
        username='coord1', email='coord@x.com', password='x', cpf='44444444444'
    )
...
def user_formador(grupos):
    ...
    user = Usuario.objects.create_user(
        username='form1', email='form@x.com', password='x', cpf='55555555555'
    )
...
def dados_basicos(grupos):
    ...
    formador1 = Usuario.objects.create_user(
        username='ana.silva', email='ana@x.com', password='x', cpf='66666666666'
    )
    formador1.groups.add(grupos['formador'])

    formador2 = Usuario.objects.create_user(
        username='joao.santos', email='joao@x.com', password='x', cpf='77777777777'
    )
...
def test_by_uf_ignores_null_municipio(user_super, dados_basicos, clear_cache):
    ...
    coord = Usuario.objects.create_user(
        username='coord_mun', email='coord_mun@x.com', password='x', cpf='99888777666'
    )
