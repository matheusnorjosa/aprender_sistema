...
from core.models import Solicitacao, Aprovacao, Formador, Municipio, Projeto, TipoEvento, AprovacaoStatus
...
def test_e2e_workflow():
    ...
    for sol in aprovadas:
        print(f'  - ID {sol.id}: {sol.titulo_evento} ({sol.data_inicio.strftime("%d/%m %H:%M")})')
