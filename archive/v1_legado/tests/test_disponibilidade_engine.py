...
class DisponibilidadeEngineTest(TestCase):
    ...
    def setUp(self):
        ...
        self.formador_1 = Formador.objects.create(
            nome="João Silva", email="joao@test.com", ativo=True
        )

        self.formador_2 = Formador.objects.create(
            nome="Maria Santos", email="maria@test.com", ativo=True
        )
        ...
        self.base_date = timezone.make_aware(
            datetime(2025, 1, 15, 8, 0), self.fortaleza_tz  # 15/01/2025 08:00
        )
    ...
    def _create_event(self, formador, inicio, fim, municipio=None, status="APROVADO"):
        ...
        user, created = Usuario.objects.get_or_create(
            username="test_user", defaults={"email": "test@test.com"}
        )
    ...
    def test_no_conflict_adjacent_end_equals_start(self):
        ...
        self._create_event(
            self.formador_1, existing_start, existing_end, self.municipio_fortaleza
        )
    ...
    def test_travel_buffer_between_cities_required(self):
        ...
        self._create_event(
            self.formador_1, fortaleza_start, fortaleza_end, self.municipio_fortaleza
        )
    ...
    def test_same_city_allows_zero_buffer(self):
        ...
        self._create_event(
            self.formador_1, event1_start, event1_end, self.municipio_fortaleza
        )
    ...
    def test_create_availability_engine_factory(self):
        ...
        engine = create_availability_engine(
            travel_buffer_minutes=120, daily_hour_limit=8
        )
        ...
        self.assertEqual(
            default_engine.travel_buffer_minutes,
            DisponibilidadeEngine.DEFAULT_TRAVEL_BUFFER_MINUTES,
        )
...
class DisponibilidadeEngineIntegrationTest(TestCase):
    ...
    def setUp(self):
        ...
        self.base_date = timezone.make_aware(
            datetime(2025, 1, 15, 8, 0), timezone.get_current_timezone()
        )
    ...
    def test_integration_with_solicitacao_model(self):
        ...
        user, created = Usuario.objects.get_or_create(
            username="test_integration", defaults={"email": "test_integration@test.com"}
        )
