...
def test_formador_eventos_simple():
    ...
    try:
        ...
        try:
            ...
            if "Formador não encontrado" in page_content or "Acesso Restrito" in page_content:
                print("⚠️ Mensagem de erro exibida (esperado se usuário não é formador)")
                print("   Isto é normal se o usuário logado não tem email correspondente a um formador")
