...
class SistemaCleaner:
    ...
    def __init__(self, root_path="."):
        ...
        self.operations = {"files_removed": [], "files_moved": [], "errors": []}
...
'''
    ...
    def execute_cleanup(self, analysis_report):
        ...
        if (
            "recomendacoes" in analysis_report
            and "consolidar" in analysis_report["recomendacoes"]
        ):
            self.consolidate_similar_scripts(
                analysis_report["recomendacoes"]["consolidar"]
            )
