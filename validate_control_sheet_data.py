...
def validate_relationships(control_data):
    ...
    for solicitacao in Solicitacao.objects.select_related('municipio', 'projeto', 'usuario_solicitante'):
        if solicitacao.municipio and solicitacao.projeto and solicitacao.usuario_solicitante:
            municipio_nome = f"{solicitacao.municipio.nome} - {solicitacao.municipio.uf}"
            ...
            if coordenador_nome and solicitacao.usuario_solicitante.cargo == 'coordenador':
    ...
    # Comparar
    relacionamentos_faltando = set(relacionamentos_planilha.keys()) - set(relacionamentos_plataforma.keys())
    relacionamentos_extras = set(relacionamentos_plataforma.keys()) - set(relacionamentos_planilha.keys())
...
def main():
    ...
    relacionamentos_faltando, relacionamentos_extras = validate_relationships(control_data)
    ...
    total_problemas = (len(municipios_faltando) + len(projetos_faltando) + 
                      len(coordenadores_faltando) + len(relacionamentos_faltando))
