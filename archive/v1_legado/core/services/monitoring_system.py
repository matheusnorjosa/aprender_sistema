...
from core.models import Formador, LogAuditoria, Solicitacao
...
class SentryMonitoring:
    ...
    def _filter_errors(self, event, hint):
        ...
        ignore_patterns = ["DisallowedHost", "SuspiciousOperation", "PermissionDenied"]
    ...
    def capture_educational_event(
        ...
        with sentry_sdk.configure_scope() as scope:
            ...
            sentry_sdk.capture_message(f"Educational Event: {event_type}", level="info")
...
class PrometheusMetrics:
    ...
    def _setup_metrics(self):
        ...
        self.cache_hit_rate = Gauge(
            "aprender_sistema_cache_hit_rate", "Cache hit rate", registry=self.registry
        )
    ...
    def record_solicitacao_created(self, status: str, projeto: str):
        ...
        self.solicitacoes_total.labels(status=status, projeto=projeto).inc()
    ...
    def record_formador_event(self, formador_id: str):
        ...
        self.formador_events_total.labels(formador_id=formador_id).inc()
    ...
    def record_calendar_operation(self, operation: str, status: str):
        ...
        self.calendar_operations_total.labels(operation=operation, status=status).inc()
    ...
    def _check_disk_space(self) -> Dict[str, Any]:
        ...
        try:
            ...
            status = (
                ...
                else "warning" if free_percentage > 5 else "critical"
            )
...
class PerformanceMonitor:
    ...
    def record_execution_time(self, operation: str, duration_ms: float):
        ...
        self.metrics[operation].append(
            {"duration_ms": duration_ms, "timestamp": datetime.now()}
        )
    ...
    def get_alerts(self, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        return sorted(
            self.performance_alerts, key=lambda x: x["timestamp"], reverse=True
        )[:limit]
