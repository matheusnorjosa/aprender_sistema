...
**Data:** 2025-10-08T22:10:31.797106
**Status:** PASS
...
- **Solicitante conformidade**: ✅ PASS
- **Views disponibilidades**: ✅ PASS
- **MarcadorPlanilha UNIQUE**: ✅ PASS

## Métricas

- **vinculos_por_papel**: {'FORMADOR': 15, 'GERENTE': 1, 'COORDENADOR': 41}
- **vinculos_por_setor**: {'Setor Teste': 5, 'ACerta': 9, 'Coordenação Geral': 35, 'Vidas': 1, 'Setor Test Dia 2': 5, 'Superintendência': 1, 'Brincando': 1}
- **total_eventos**: 2178
- **eventos_por_status**: {'REALIZADO': 1712, 'CRIADO': 263, 'CANCELADO': 95, 'APROVADO': 108}
- **solicitante_conformidade_pct**: 100.0
