...
from core.models import Usuario, Setor, Municipio, Projeto, TipoEvento, Solicitacao, SolicitacaoStatus
...
def create_solicitacao_from_event(event_data):
    ...
    title = dados.get('Título', '') or dados.get('titulo', '') or dados.get('município', '')
