...
from core.models import (
    ...
    Solicitacao, Aprovacao, EventoGoogleCalendar,
...
class SolicitacaoViewSet(viewsets.ModelViewSet):
    ...
    filterset_fields = [
        'status', 'projeto', 'municipio', 'tipo_evento',
...
class EstatisticasViewSet(viewsets.ViewSet):
    ...
    def por_periodo(self, request):
        ...
        aprovacoes_periodo = Aprovacao.objects.filter(
            data_decisao__gte=data_inicio
        )
