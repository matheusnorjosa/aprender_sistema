...
class Command(BaseCommand):
    ...
    def process_superintendencia(self):
        ...
        try:
            ...
            self.stdout.write(f'Usuários vinculados ao setor: {stats["usuarios_vinculados_setor"]}')
            self.stdout.write(f'Usuários vinculados a grupos: {stats["usuarios_vinculados_grupo"]}')
            ...
            self.stdout.write(self.style.ERROR('Arquivo superintendencia.xlsx não encontrado'))
        except Exception as e:
            self.stdout.write(self.style.ERROR(f'Erro ao processar superintendência: {e}'))
            raise