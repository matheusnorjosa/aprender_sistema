...
def fix_projects():
    ...
    projetos_invalidos = [
        'TRUE', 'Outros', 'Bloqueios', 'Compras', 'Deslocamentos', 
        'Superintendência', 'Cataventos', 'Cirandar', 'Lendo', 
        'Miudezas', 'PROJETO UNI DUNI TÊ 4', 'UNI DUNI TÊ'
    ]
        ...
        try:
            ...
            if solicitacoes.exists():
                ...
                if projeto_tema:
                    ...
                    print(f"   🔄 Movidas {solicitacoes.count()} solicitações de '{nome_projeto}' para 'Tema'")
...
def verify_projects():
    ...
    for projeto in projetos:
        ...
        print(f"  - {projeto.nome} (setor: {setor_nome}) - {solicitacoes_count} solicitações")
