...
class TestGCalPublishBatchEndpoint:
    ...
    def test_batch_publish_aprovados_sucesso(self, mock_task, api_client, usuario_controle, solicitacao_aprovada):
        """
        ...
        response = api_client.post(
            ...
            {"solicitacao_ids": [solicitacao_aprovada.id, sol2.id], "dry_run": False, "apply_blocked": False},
            format="json",
        )
    ...
    def test_batch_publish_mistura_aprovado_pendente(
        self, mock_task, api_client, usuario_controle, solicitacao_aprovada, solicitacao_pendente
    ):
        """
    ...
    def test_batch_publish_requer_apply_blocked_quando_fake(self, api_client, usuario_controle, solicitacao_aprovada):
        """
        ...
        response = api_client.post(
            "/api/gcal/publish-batch/",
            {"solicitacao_ids": [solicitacao_aprovada.id], "dry_run": False, "apply_blocked": False},
            format="json",
        )
    ...
    @patch("apps.core.tasks.task_publish_solicitacao_to_gcal")
    @override_settings(GCAL_CLIENT="fake")
    def test_batch_publish_com_apply_blocked_true(self, mock_task, api_client, usuario_controle, solicitacao_aprovada):
        """
        ...
        response = api_client.post(
            "/api/gcal/publish-batch/",
            {"solicitacao_ids": [solicitacao_aprovada.id], "dry_run": False, "apply_blocked": True},
            format="json",
        )
    ...
    def test_batch_publish_rbac_403_sem_permissao(self, api_client, usuario_comum, solicitacao_aprovada):
        """
    ...
    def test_batch_publish_array_vazio(self, api_client, usuario_controle):
        """
        ...
        response = api_client.post("/api/gcal/publish-batch/", {"solicitacao_ids": [], "dry_run": False}, format="json")
    ...
    @patch("apps.core.tasks.task_publish_solicitacao_to_gcal")
    @override_settings(GCAL_CLIENT="google")
    def test_batch_publish_dry_run_nao_persiste(self, mock_task, api_client, usuario_controle, solicitacao_aprovada):
        """
        ...
        response = api_client.post(
            "/api/gcal/publish-batch/",
            {"solicitacao_ids": [solicitacao_aprovada.id], "dry_run": True, "apply_blocked": False},
            format="json",
        )
    ...
    def test_batch_publish_id_inexistente(self, api_client, usuario_controle):
        """
        ...
        response = api_client.post(
            "/api/gcal/publish-batch/",
            {"solicitacao_ids": [99999], "dry_run": False, "apply_blocked": False},
            format="json",
        )
