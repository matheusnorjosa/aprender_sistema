...
## Observações
- Todos os detalhes, evidências e listas completas de arquivos explorados estão nos relatórios de cada fase.
- Posso gerar um índice navegável com links internos se quiser.
