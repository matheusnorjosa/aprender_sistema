...
def main():
    ...
    try:
        sync_perm = Permission.objects.get(codename='sync_calendar', content_type__app_label='core')
        ...
        print(f"   Usuários com permissão direta: {[u.username for u in users_with_sync]}")
