...
class AssetOptimizer:
    ...
    def optimize_css_file(self, input_path, output_path=None):
        ...
        if output_path is None:
            output_path = (
                input_path.parent / f"{input_path.stem}.min{input_path.suffix}"
            )
        ...
        return {
            ...
            "compression_ratio": 1
            - (len(minified_css.encode("utf-8")) / len(css_content.encode("utf-8"))),
            **compression_stats,
        }
    ...
    def optimize_js_file(self, input_path, output_path=None):
        ...
        return {
            ...
            "compression_ratio": 1
            - (len(minified_js.encode("utf-8")) / len(js_content.encode("utf-8"))),
            **compression_stats,
        }
    ...
    def optimize_all_assets(self):
        ...
        for css_file in css_files:
            ...
            results["total_savings"] += (
                result["original_size"] - result["minified_size"]
            )
        ...
        if results["total_original_size"] > 0:
            results["overall_compression_ratio"] = (
                results["total_savings"] / results["total_original_size"]
            )
        else:
