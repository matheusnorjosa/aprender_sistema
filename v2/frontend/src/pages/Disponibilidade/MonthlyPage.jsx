...
export default function MonthlyPage() {
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      ...
      {/* Legenda (prioriza backend de formadores, fallback para coordenadores) */}
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          {coordenadores.data && (
            <button
              ...
              className="px-3 py-2 text-sm font-medium text-white bg-green-600 hover:bg-green-700 rounded"
            >
              Exportar CSV (Coordenadores)
            </button>
          )}
        </div>
