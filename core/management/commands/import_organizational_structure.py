...
from core.models import Setor, Usuario, Projeto
...
class Command(BaseCommand):
            ...
            for idx, row in df.iterrows():
                try:
                    ...
                    if setor:
                        ...
                        if created:
                            projetos_criados += 1
                            self.stdout.write(f'✓ Projeto criado: {projeto.nome} → {setor.nome}')
    ...
    def determine_setor_by_project_name(self, project_name):
        ...
        mappings = {
            'superintendencia': ['novo lendo', 'lendo e escrevendo', 'tema', 'amma', 'uni duni', 'cataventos', 'miudezas'],
            'vidas': ['vida', 'vidas'],
            'acerta': ['acerta'],
            'brincando': ['brincando'],
            'fluir': ['fluir'],
