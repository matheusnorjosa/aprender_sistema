    ...
    try:
        ...
        for aba_nome, aba_data in data['worksheets'].items():
            ...
            if 'Email' in headers:
                ...
                if email_col >= 0:
                    emails = [row[email_col] for row in aba_data['data'] 
            ...
            if aba_nome == 'Eventos':
                ...
                if len(aba_data['data']) > 0:
                    ...
                    if 'tipo' in headers:
                        ...
                        tipos = [row[tipo_col] for row in aba_data['data'] 
                                if len(row) > tipo_col and row[tipo_col]]
                        tipo_counter = Counter(tipos)
                        print(f"Tipos de eventos: {dict(list(tipo_counter.most_common(5)))}")
                ...
                if len(aba_data['data']) > 0:
                    ...
                    if 'Origem' in headers:
                        ...
                        origens = [row[origem_col] for row in aba_data['data'] 
                                  if len(row) > origem_col and row[origem_col]]
                        origem_counter = Counter(origens)
                        print(f"Origens mais comuns: {dict(list(origem_counter.most_common(3)))}")
...
def analyze_acompanhamento():
    ...
    try:
        ...
        abas_importantes = ['Super', 'Google Agenda', 'Novo Google Agenda', 'Bloqueios', 'Configurações']
            ...
            if aba_nome in abas_importantes:
                ...
                if aba_nome == 'Google Agenda':
                    ...
                    if 'Title' in headers:
                        ...
                        titulos = [row[title_col] for row in aba_data['data'][:10] 
                    ...
                    if len(aba_data['data']) > 0:
                        ...
                        if 'Pessoa' in headers:
                            ...
                            pessoas = [row[pessoa_col] for row in aba_data['data'] 
                                      if len(row) > pessoa_col and row[pessoa_col]]
                            pessoa_counter = Counter(pessoas)
                            print(f"Pessoas com mais bloqueios: {dict(list(pessoa_counter.most_common(3)))}")
                    ...
                    if 'Município' in headers:
                        ...
                        municipios = [row[municipio_col] for row in aba_data['data'] 
