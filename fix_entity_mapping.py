...
class EntityMappingFixer:
    ...
    def fix_municipios(self):
        ...
        try:
            ...
            print(f"  📊 Total de municípios corrigidos: {self.stats['municipios_fixed']}")
    ...
    def map_coordenadores(self):
        ...
        try:
            ...
            print(f"  📊 Total de coordenadores mapeados: {self.stats['coordenadores_created']}")
    ...
    def map_formadores(self):
        ...
        try:
            ...
            print(f"  📊 Total de formadores mapeados: {self.stats['formadores_created']}")
        ...
        try:
            ...
            for usuario in usuarios_sem_setor:
                if setor_outros:
                    ...
                    print(f"  ✅ Setor 'Outros' atribuído ao usuário: {usuario.get_full_name()}")
            ...
            for usuario in usuarios_sem_cargo:
                if usuario.cargo == '':
                    ...
                    usuario.save()
                    self.stats['usuarios_updated'] += 1
                    print(f"  ✅ Cargo 'outros' atribuído ao usuário: {usuario.get_full_name()}")
            
            print(f"  📊 Total de usuários corrigidos: {self.stats['usuarios_updated']}")
