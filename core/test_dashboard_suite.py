...
from core.models import (
    ...
    Formador, FormadoresSolicitacao
)
...
class DashboardTestSuite(TestCase):
    ...
    def _criar_dados_completos(self):
        ...
        # Projetos
        self.projeto1 = Projeto.objects.create(nome='Projeto Alpha', descricao='Primeiro projeto')
        self.projeto2 = Projeto.objects.create(nome='Projeto Beta', descricao='Segundo projeto')
        ...
        # Tipo de evento
        self.tipo_evento = TipoEvento.objects.create(nome='Workshop Suite', online=False)
        
        # Formadores
        self.formador1 = Formador.objects.create(nome='João Suite', email='joao@suite.com', ativo=True)
        self.formador2 = Formador.objects.create(nome='Maria Suite', email='maria@suite.com', ativo=True)
        self.formador3 = Formador.objects.create(nome='Pedro Suite', email='pedro@suite.com', ativo=False)
        ...
        FormadoresSolicitacao.objects.create(solicitacao=evento1, formador=self.formador1)
        ...
        FormadoresSolicitacao.objects.create(solicitacao=evento2, formador=self.formador2)
        ...
        FormadoresSolicitacao.objects.create(solicitacao=evento3, formador=self.formador1)
        ...
        FormadoresSolicitacao.objects.create(solicitacao=evento4, formador=self.formador2)
    ...
    def test_api_basica_response_structure(self):
        ...
        required_fields = ['timestamp', 'periodo_referencia', 'filtros', 'estatisticas', 'meta']
        for field in required_fields:
            self.assertIn(field, data)
            
        # Verificar estatísticas
        stats = data['estatisticas']
        stats_fields = ['eventos_periodo', 'formadores_ativos', 'solicitacoes_pendentes', 'municipios_atendidos']
    ...
    def test_metricas_avancadas_structure(self):
        ...
        expected_fields = ['taxa_aprovacao', 'top_formadores', 'top_municipios', 'tendencia_semanal']
    ...
    def test_metricas_taxa_aprovacao(self):
        ...
        if taxa['total_solicitacoes'] > 0:
            expected_percentual = round((taxa['aprovadas'] / taxa['total_solicitacoes']) * 100, 1)
    ...
    def test_integracao_compatibilidade_retroativa(self):
        ...
        basic_stats = ['eventos_periodo', 'formadores_ativos', 'solicitacoes_pendentes', 'municipios_atendidos']
    ...
    def tearDownClass(cls):
        ...
        print(f"Métricas Avançadas (COMMIT 5): {cls.test_results['metricas_avancadas']} testes")
