    ...
    def create_demo_data(self):
        ...
        try:
            ...
            if (
                ...
                and projetos.exists()
                and municipios.exists()
                and tipos_evento.exists()
            ):
    ...
    def verify_final_data(self):
        ...
        try:
            ...
            stats = {
                ...
                "formadores_ativos": Usuario.objects.filter(
                    formador_ativo=True
                ).count(),
            ...
            if (
                stats["coordenadores"] > 0
                and stats["formadores"] > 0
                and stats["solicitacoes"] > 0
            ):
