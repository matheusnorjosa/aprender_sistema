...
from core.models import Solicitacao, SolicitacaoStatus, EventoGoogleCalendar, LogAuditoria, Projeto, Formador
...
class ControlePreAgendaView(LoginRequiredMixin, PermissionRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            ...
            'formadores_filter': Formador.objects.filter(ativo=True).order_by('nome'),
