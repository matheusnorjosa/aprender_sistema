                        ...
                        if len(linha) >= len(cabecalhos):
                            ...
                            if projeto_linha == projeto_nome:
                                if coordenador_linha:
                                    coordenadores_projeto.add(normalizar_nome(coordenador_linha))
                                for formador in formadores_linha:
                                    if formador:
                                        formadores_projeto.add(normalizar_nome(formador))
                                if gerente_linha:
                    ...
                    if dados_usuarios:
                        ...
                        for linha in dados_usuarios[1:]:
                            if len(linha) >= len(cabecalhos_usuarios):
                                ...
                                if categoria == "Superintendência" and gerencia == "Superintendência":
                                    pertence_categoria = True
                                elif categoria == "ACerta" and "acerta" in gerencia.lower():
                                    pertence_categoria = True
                                elif categoria == "Brincando" and "brincando" in gerencia.lower():
                                    pertence_categoria = True
                                elif categoria == "Vidas" and "vidas" in gerencia.lower():
                                    pertence_categoria = True
                                elif categoria == "Projetos_Específicos" and gerencia not in ["Superintendência", "ACerta", "Brincando"] and "vidas" not in gerencia.lower():
                                    pertence_categoria = True
