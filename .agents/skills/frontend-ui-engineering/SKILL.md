...
Stack: **React 18 + Ant Design v5 + Tailwind CSS + Vite 7**. Goal: UI that matches AS v2's
existing design language, not AI-generated-looking output.
...
| `fetchPriority` camelCase | React 18 warning | lowercase `fetchpriority` |
